const BASE_URL = "http://aquaria-app.h2bis.com/api";

const kLoginURL = "$BASE_URL/login";
...
const kLoadSupReq = "$BASE_URL/advertisements";
// const kLoadAdvertisements = "$BASE_URL/advertisements";
const kLoadAdvertisements = "$BASE_URL/advertisements/published";
const kSaveOrder = "$BASE_URL/orders";
const kGetSUbOrder = "$BASE_URL/sub-orders";
